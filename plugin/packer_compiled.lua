...
_G.packer_plugins = {
  ["clangd_extensions.nvim"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/clangd_extensions.nvim",
  ...
  ["cmp-nvim-lsp-signature-help"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/cmp-nvim-lsp-signature-help",
  ...
  ["hlargs.nvim"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/hlargs.nvim",
  ...
  ["monokai.nvim"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/monokai.nvim",
  ...
  tagbar = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/tagbar",
  ...
  vimspector = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/vimspector",
